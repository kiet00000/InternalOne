<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chikna.aspx.cs" Inherits="NewFinalFYP.Videos.chikna" %>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="Login.aspx" aria-expanded="false"><i class="far fa-circle text-success"></i><span class="hide-menu">Log Out</span></a></li>
                    </ul>
                </nav>
